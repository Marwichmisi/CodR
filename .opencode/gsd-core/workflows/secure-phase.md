...
```
Agent(
  prompt="Read /home/marwane/Documents/CodR/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/marwane/Documents/CodR/.opencode/gsd-core/templates/SECURITY.md`
