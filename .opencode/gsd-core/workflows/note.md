...
- **Global scope**: `/home/marwane/Documents/CodR/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/marwane/Documents/CodR/.opencode/notes/`)
...
2. Glob `/home/marwane/Documents/CodR/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/marwane/Documents/CodR/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/marwane/Documents/CodR/.opencode/notes/` — works in any directory
