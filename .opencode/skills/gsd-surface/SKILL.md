...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/marwane/Documents/CodR/.opencode/.gsd-surface.json`
(sibling to `/home/marwane/Documents/CodR/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/marwane/Documents/CodR/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/marwane/Documents/CodR/.opencode/skills`).
...
`/home/marwane/Documents/CodR/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/marwane/Documents/CodR/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/marwane/Documents/CodR/.opencode/.gsd-surface.json`
Install profile marker: `/home/marwane/Documents/CodR/.opencode/.gsd-profile`
Skill dirs: `/home/marwane/Documents/CodR/.opencode/skills/gsd-*/`
Engine module: `/home/marwane/Documents/CodR/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/marwane/Documents/CodR/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
